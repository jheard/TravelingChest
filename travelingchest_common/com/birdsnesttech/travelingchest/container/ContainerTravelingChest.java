package com.birdsnesttech.travelingchest.container;
...
public class ContainerTravelingChest extends ContainerTFC {
	private IInventory lowerChestInventory;
	private int numRows;

	public ContainerTravelingChest(IInventory playerInv, IInventory chestInv, World world, int x, int y, int z)
	{
		TETravelingChest chest = (TETravelingChest)chestInv;
